...
enum AddressValidation {
    static func isValid(_ address: String, kind: String) -> Bool {
        coreValidateAddress(request: AddressValidationRequest(kind: kind, value: address)).isValid
    }
    static func normalized(_ address: String, kind: String) -> String? {
        coreValidateAddress(request: AddressValidationRequest(kind: kind, value: address)).normalizedValue
    }
}

...
struct StakingView: View {
    ...
    private func chainTile(_ chain: Chain, _ descriptor: StakingChainDescriptor) -> some View {
        VStack(alignment: .leading, spacing: 10) {
            HStack(spacing: 10) {
                CoinBadge(
                    artworkName: coreHoldingArtworkName(holding: AssetHolding(name: "", symbol: "", coinGeckoId: "", chainName: chain.displayName, tokenStandard: "Native", contractAddress: nil, amount: 0, priceUsd: 0)),

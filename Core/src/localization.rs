...
const EMBEDDED_DOCUMENTS: &[EmbeddedDocument] = &[
    ...
    EmbeddedDocument {
        locale: "zh-Hans",
        table: "DiagnosticsContent",
        json: include_str!("../../Resources/Localization/zh-Hans/DiagnosticsContent.zh-Hans.json"),
    },
    EmbeddedDocument {
        locale: "zh-Hans",
        table: "DonationsContent",
    ...
    EmbeddedDocument {
        locale: "zh-Hans",
        table: "ImportFlowContent",
        json: include_str!("../../Resources/Localization/zh-Hans/ImportFlowContent.zh-Hans.json"),
    },
    EmbeddedDocument {
        locale: "zh-Hans",
        table: "SettingsContent",
    ...
    EmbeddedDocument {
        locale: "zh-Hant",
        table: "DiagnosticsContent",
        json: include_str!("../../Resources/Localization/zh-Hant/DiagnosticsContent.zh-Hant.json"),
    },
    EmbeddedDocument {
        locale: "zh-Hant",
        table: "DonationsContent",
    ...
    EmbeddedDocument {
        locale: "zh-Hant",
        table: "ImportFlowContent",
        json: include_str!("../../Resources/Localization/zh-Hant/ImportFlowContent.zh-Hant.json"),
    },
    EmbeddedDocument {
        locale: "zh-Hant",
        table: "SettingsContent",

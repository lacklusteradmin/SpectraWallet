    ...
    func startSending(
        ...
        let content = ActivityContent<SendTransactionLiveActivityAttributes.ContentState>(
            state: SendTransactionLiveActivityAttributes.ContentState(
                ...
                detailText: "Sending to \(previewText(for: destinationAddress))",
                destinationPreview: previewText(for: destinationAddress),
    ...
    func complete(
        ...
        let content = ActivityContent<SendTransactionLiveActivityAttributes.ContentState>(
            state: SendTransactionLiveActivityAttributes.ContentState(
                ...
                destinationPreview: previewText(for: destinationAddress),
                transactionHashPreview: previewText(for: transactionHash),
    ...
    func fail(message: String?) async {
        ...
        let content = ActivityContent<SendTransactionLiveActivityAttributes.ContentState>(
            state: SendTransactionLiveActivityAttributes.ContentState(
                ...
                chainName: currentState.chainName,
                symbol: currentState.symbol,
                amountText: currentState.amountText,
                statusText: trimmedMessage.isEmpty ? "Send Cancelled" : "Send Failed",
                detailText: detailText,
                destinationPreview: currentState.destinationPreview,
                transactionHashPreview: nil,
